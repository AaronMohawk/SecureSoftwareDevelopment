// I, Aaron Atkinson, student number 000371388, certify that this material is my
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, Company = model.Company, Position = model.Position, BirthDate = model.BirthDate };
        ...
        public async Task<IActionResult> SeedRoles()
        {
            ...
            {
                Email = "joseph.varrasso@mohawkcollege.ca",
                UserName = "JoeV",
                FirstName = "Joseph",
                LastName = "Varrasso"
            };
            ...
            if (!result.Succeeded)
                return View("Error", new ErrorViewModel { RequestId = "Failed to assign new role" });
            result = await _userManager.AddToRoleAsync(user3, "Manager");
            if (!result.Succeeded)
                return View("Error", new ErrorViewModel { RequestId = "Failed to assign new role" });
